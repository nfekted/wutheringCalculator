export class XiangliYao {
    name: string = 'Xiangli Yao'
    icon: string = 'xiangliyao';
    wiki: string = 'https://wutheringwaves.fandom.com/wiki/Xiangli_Yao';
    type: string = 'electro';
    weapon: string = 'gauntlets';
    //Basic Attacks
    basicNames: string[] = [];
